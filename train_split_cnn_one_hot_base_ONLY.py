...
def train(model, data_loader, optimizer, input_channels, n_batches, results_handler, checkpoint_interval, loss_fn_repeat, loss_fn_base, consensus_caller):
    ...
    for b, batch in enumerate(data_loader):
        ...
        y_pileup_n = y_pileup[0,:,0,:]  # ignore the depth dimension because y has always 1 "coverage" or height
        y_pileup_predict_n = y_pileup_predict[0,:,:]  # ignore the depth dimension because y has always 1 "coverage" or height
        ...
        #     consensus_caller.expand_collapsed_consensus_as_string(consensus_indices=y_pileup_n,
